...
namespace ChainSafe.UnityJSONSceneExporter
{
#if UNITY_EDITOR
    ...
    public class SceneExporter : MonoBehaviour
    {
        ...
        [SerializeField]
        private string m_ExportPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "UnityJSON");
        [SerializeField]
