...
public class IpfsObject : MonoBehaviour {
    ...
    public async Task<string> Write(IpfsGenesis gen, string addhash)
    {
        ...
        JSONGameObject jsonGameObject = ob.ToJSONGameObject();
       ...
       // Debug.Log("Debugged Object: " + Newtonsoft.Json.JsonConvert.SerializeObject(jsonGameObject));
...
public class Object
{
    ...
    public GameObject GameObject()
    {
        ...
        Debug.Log("Verts: " + newmesh.vertices);
